...
const menuItemImageFiles: Record<string, string> = {
  ...
  'Sugarcane Juice': 'usacha ras .jpeg',
};

const resolveMenuImageFromFolder = (itemName: string) => {
  const fileName = menuItemImageFiles[itemName];
  if (!fileName) return '';
  return new URL(`../../images of meanue item/${fileName}`, import.meta.url).href;
};
...
export const chaatItems: MenuItem[] = [
  ...
  },
  {
    ...
    price: 60, ...getItemImage('Cheese Bhel', cheeseFarsanBhelImage), category: 'chaat',
  },
  {
    ...
    price: 60, ...getItemImage('Farsan Bhel', bhelpuriImage), category: 'chaat',
  },
  {
    ...
    price: 70, ...getItemImage('Cheese Farsan Bhel', cheeseFarsanBhelImage), category: 'chaat',
  },
  {
    ...
    price: 50, ...getItemImage('Dahi Bhel', dahiBhelImage), category: 'chaat',
  },
  {
  ...
  },
  {
    ...
    price: 35, ...getItemImage('Chura Puri', churaPuriImage), category: 'chaat',
  },
  {
    ...
    price: 25, ...getItemImage('Pani Puri', paniPuriImage), category: 'chaat',
  ...
  },
  {
    ...
    price: 40, ...getItemImage('Sev Puri', sevPuriImage), category: 'chaat',
  },
  {
    ...
    price: 40, ...getItemImage('Dahi Puri', dahiPuriImage), category: 'chaat',
  },
  {
  ...
  },
  {
    ...
    price: 40, ...getItemImage('Cheese Sukhi Puri', cheeseSukhiPuriImage), category: 'chaat',
  },
  {
    ...
    price: 40, ...getItemImage('Cheese Pani Puri', paniPuriImage), category: 'chaat',
  },
  {
    ...
    price: 50, ...getItemImage('Cheese Dahi Puri', dahiPuriImage), category: 'chaat',
  },
  {
    ...
    price: 50, ...getItemImage('Cheese Sev Puri', cheeseSevPuriImage), category: 'chaat',
  },
  {
    ...
    price: 40, ...getItemImage('Ragda', ragdaImage), category: 'chaat',
  },
  {
    ...
    price: 50, ...getItemImage('Cheese Ragda', cheeseRagdaImage), category: 'chaat',
  },
  {
    ...
    price: 20, ...getItemImage('Dabeli', cheeseDabeliImage), category: 'chaat',
  },
  {
    ...
    price: 40, ...getItemImage('Cheese Dabeli', cheeseDabeliImage), category: 'chaat',
  },
  {
    ...
    price: 40, ...getItemImage('Mayonnaise Dabeli', mayonnaiseDabeliImage), category: 'chaat',
  },
];
...
export const juiceItems: MenuItem[] = [
  {
    ...
    price: 30, ...getItemImage('Sugarcane Juice', sugarcaneJuiceImage), category: 'juice',
