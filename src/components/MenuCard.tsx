    ...
    >
      ...
      <div className="p-3.5">
        ...
        <a
          ...
          className={`mt-3 inline-flex items-center gap-1.5 text-[11px] font-bold px-4 py-2 rounded-full transition-all hover:scale-105 active:scale-95 shadow-sm ${isJuice ? 'bg-[hsl(var(--juice))] text-[hsl(var(--juice-foreground))]' : 'bg-accent text-accent-foreground'}`}
        >
